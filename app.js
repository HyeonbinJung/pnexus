...
const I18N = {
  ko: {
    ...
    heroTag:'애니메이션 스튜디오 × 소프트웨어 컴퍼니', h1a:'우리는', h1b:'움직이는', h1c:'것을 만듭니다',
    heroSub:'광고용 애니메이션을 제작하고, 거기서 쌓은 크리에이티브·유통 역량으로 Paratus Nexus가 직접 만든 소프트웨어를 출시합니다. 본사는 서울에 있으며, 인도와 미국이 첫 출시 시장입니다.',
    ...
    stickerA:'시장 · 인도 & 미국', stickerB:'회원제 소프트웨어', stickerC:'애니메이션으로 마케팅',
    marquee:['애니메이션 제작','광고 마케팅','Psyche Check','ResumeFix AI','서울 본사','인도 · 미국','회원제','모션 디자인'],
    stats:[{v:120,suffix:'+',label:'제작한 애니메이션 편수'},{v:2,suffix:'',label:'첫 출시 시장 (인도 · 미국)'},{v:38,suffix:'K+',label:'오디언스 · 커뮤니티 도달'},{v:5.5,suffix:'M',label:'최고 오가닉 조회수',dec:1}],
    ...
    acctTag:'우리 애니메이션 계정', acctH:'매일 올리고, 매일 봅니다', acctSub:'자체 애니메이션 채널이 곧 유통 채널입니다. 콘텐츠를 오가닉으로 테스트하고, 반응을 배우고, 그 인사이트를 제품 출시에 적용합니다.',
    ...
    revTag:'수익', revH:'숫자로 보는 지금', revSub:'2026년 5월–9월 누적 회사 수익. 소프트웨어는 아직 출시 전이며, 현재 수익은 서울 법인이 수행하는 애니메이션·광고 활동에서 발생합니다.',
    revenue:[{label:'애니메이션 수익',amount:'약 2,000만원',note:'2026.05 – 2026.09'},{label:'광고 수익',amount:'약 500만원',note:'2026.05 – 2026.09'},{label:'소프트웨어 수익',amount:'0원',note:'출시 전'}],
    ...
    softTag:'소프트웨어', softH:'Paratus Nexus가 개발한 제품', softSub:'애니메이션 사업에서 쌓은 크리에이티브·유통 역량으로 인도와 미국에 컨슈머 소프트웨어를 출시합니다.',
    products:[{name:'Psyche Check',badge:'라이브 데모 ↓',desc:'20문항으로 내가 사람들과 어떻게 관계 맺는지 가볍게 알아보는 성향 퀴즈. 재미로 시작해서 친구에게 공유하게 됩니다.',chips:['5분 소요','결과 공유 카드','영어 · 힌디어 · 한국어']},{name:'ResumeFix AI',badge:'회원 전용',desc:'이력서를 올리면 직무 설명에 맞춰 문장을 고치고, 인도·미국 채용 시장 기준으로 형식을 맞춰줍니다.',chips:['ATS 형식 검사','문장 단위 수정','미국 · 인도 포맷']}],
    ...
    flyH:'우리의 플라이휠', flySub:'애니메이션이 관심을 만들고, 관심이 제품이 됩니다.', flywheel:[{step:'Create',desc:'애니메이션이 관심을 만듭니다.'},{step:'Distribute',desc:'자체 채널이 유통을 담당합니다.'},{step:'Learn',desc:'오디언스 데이터가 제품 아이디어를 알려줍니다.'},{step:'Build',desc:'그 인사이트로 소프트웨어를 만듭니다.'},{step:'Monetize',desc:'소프트웨어가 관심을 반복 수익으로 바꿉니다.'}],
    regionTag:'본사와 시장', regionH:'서울 본사, 두 개의 시장', regions:[{name:'South Korea',tag:'본사',desc:'서울. 본사, 애니메이션 제작, 회사 운영.',chips:['서울','한국어 · 영어']},{name:'India',tag:'시장',desc:'첫 컨슈머 시장. 힌디어·영어 현지화.',chips:['힌디어 · 영어']},{name:'United States',tag:'시장',desc:'첫 컨슈머 시장. 영어 제품과 미국 현지화.',chips:['영어']}],
    teamH:'팀', team:[{name:'김민지',role:'CEO',edu:'애니메이션 · 마케팅 · 회사 운영 · 서울'},{name:'정현빈',role:'공동창업자 · 기술',edu:'컬럼비아 대학교 · 컴퓨터과학 · 수학'},{name:'문준용',role:'PM',edu:'엠브리리들 대학교 · 항공운항학과'},{name:'신영현',role:'Audit · 법률 자문',edu:'감사 및 법률 자문 담당'}],
    faqH:'자주 묻는 질문', faq:[{q:'회사는 어디에 있나요?',a:'Paratus Nexus 본사는 서울에 있습니다. 인도와 미국은 첫 출시 시장입니다.'},{q:'애니메이션만 외주로 맡길 수 있나요?',a:'가능합니다. 다만 우리 애니메이션은 자사 소프트웨어 마케팅에 최적화된 팀이라, 제품 광고·설명 영상에 특히 강합니다.'},{q:'회원제 요금은 얼마인가요?',a:'아직 공개 전입니다. 문의를 남겨주시면 얼리 액세스 가격을 먼저 안내드립니다.'},{q:'Psyche Check는 진짜 진단인가요?',a:'아닙니다. 오락과 자기 탐색용 성향 테스트이며 임상 도구가 아닙니다.'},{q:'한국에서도 쓸 수 있나요?',a:'소프트웨어는 전 세계에서 접속 가능합니다. 마케팅과 결제는 현재 인도·미국에 맞춰져 있습니다.'}],
    ctaH:'같이 움직여 볼까요?', ctaSub:'얼리 액세스, 애니메이션 제작 문의, 파트너십 제안 모두 여기로. 이메일만 남겨주세요.', emailPh:'이메일 주소', ctaBtn:'문의 남기기', ctaSent:'받았습니다 ✓',
    footer:'서울, 대한민국 · 인도와 미국 시장에 서비스'
  },
  en: {
    navReel:'Reel', navAcct:'Accounts', navRev:'Revenue', navSoft:'Software', navDemo:'Demo', navTeam:'Team', navCta:'Get in touch', lang:'한국어',
    heroTag:'Animation studio × software company', h1a:'We make', h1b:'things', h1c:'that move',
    heroSub:'We produce animation for advertising, then apply the same creative and distribution capabilities to software products built by Paratus Nexus. Our headquarters are in Seoul, with India and the United States as our initial launch markets.',
    ...
    stickerA:'Markets · India & USA', stickerB:'Members-only software', stickerC:'Marketed with animation',
    marquee:['Animation','Ad marketing','Psyche Check','ResumeFix AI','Seoul HQ','India · United States','Membership','Motion design'],
    stats:[{v:120,suffix:'+',label:'Animations produced'},{v:2,suffix:'',label:'Initial launch markets'},{v:38,suffix:'K+',label:'Audience & community reach'},{v:5.5,suffix:'M',label:'Peak organic views',dec:1}],
    ...
    acctTag:'Our animation accounts', acctH:'Posted daily, watched daily', acctSub:'Our owned animation channels double as distribution. We test creative organically, learn what audiences respond to, and apply those insights to product launches.',
    ...
    revTag:'Revenue', revH:'Where the numbers stand', revSub:'Cumulative company revenue, May–September 2026. Software products remain pre-launch; current revenue is generated by animation and advertising activities conducted through the Seoul-based business.',
    revenue:[{label:'Animation revenue',amount:'≈ $14,500',note:'May – Sep 2026'},{label:'Advertising revenue',amount:'≈ $3,600',note:'May – Sep 2026'},{label:'Software revenue',amount:'$0',note:'Pre-launch'}],
    ...
    softTag:'Software', softH:'Products developed by Paratus Nexus', softSub:'We use the creative and distribution capabilities developed through our animation business to launch consumer software in India and the United States.',
    products:[{name:'Psyche Check',badge:'Live demo ↓',desc:'A 20-question personality quiz about how you relate to other people. Starts as fun, ends up shared with friends.',chips:['5 minutes','Shareable result card','English · Hindi · Korean']},{name:'ResumeFix AI',badge:'Members only',desc:'Upload a resume; it rewrites lines against the job description and reformats for Indian and US hiring standards.',chips:['ATS format check','Line-level edits','US · India formats']}],
    ...
    flyH:'Our flywheel', flySub:'Animation builds attention; attention becomes products.', flywheel:[{step:'Create',desc:'Animation builds attention.'},{step:'Distribute',desc:'Owned channels provide distribution.'},{step:'Learn',desc:'Audience data informs product ideas.'},{step:'Build',desc:'Those insights become software.'},{step:'Monetize',desc:'Software converts attention into recurring revenue.'}],
    regionTag:'Headquarters & markets', regionH:'Seoul HQ, two launch markets', regions:[{name:'South Korea',tag:'Headquarters',desc:'Seoul. Corporate headquarters, animation production and company operations.',chips:['Seoul','Korean · English']},{name:'India',tag:'Market',desc:'Initial consumer market with Hindi and English localization.',chips:['Hindi · English']},{name:'United States',tag:'Market',desc:'Initial consumer market with English-language products and U.S.-specific localization.',chips:['English']}],
    teamH:'Team', team:[{name:'Minji Kim',role:'CEO',edu:'Animation · Marketing · Company Operations · Seoul'},{name:'Hyunbin Jung',role:'Co-founder · Technology',edu:'Columbia University · Computer Science & Mathematics'},{name:'Junyong Moon',role:'PM',edu:'Embry-Riddle Aeronautical University · Aeronautical Science'},{name:'Younghyun Shin',role:'Audit · Legal Counsel',edu:'Audit and legal advisory'}],
    faqH:'FAQ', faq:[{q:'Where is the company based?',a:'Paratus Nexus is headquartered in Seoul, South Korea. India and the United States are our first launch markets.'},{q:'Can we hire you just for animation?',a:'Yes. Our team is tuned for marketing our own software, so we are strongest on product ads and explainers.'},{q:'How much is membership?',a:'Not public yet. Leave a note and we will share early-access pricing first.'},{q:'Is Psyche Check a real diagnosis?',a:'No. It is an entertainment and self-reflection test, not a clinical tool.'},{q:'Does it work outside India and the US?',a:'The software is accessible worldwide. Marketing and billing are currently set up for India and the US.'}],
    ctaH:'Shall we move together?', ctaSub:'Early access, animation projects, partnerships. Just leave an email.', emailPh:'Email address', ctaBtn:'Send', ctaSent:'Got it ✓',
    footer:'Seoul, Republic of Korea · Serving India and the United States'
  }
};
...
<section class="section">
  <div class="sec-head"><h2 class="h2">${esc(L.flyH)}</h2><p>${esc(L.flySub)}</p></div>
  <div class="flow-grid">
    ${L.flywheel.map((f, i) => `<div class="flow" style="background:${['#F3F1EA','#FF5A36','#7B5CFF','#C6FF3D','#37E5FF'][i]};color:${i === 2 ? '#F3F1EA' : '#0B1026'};--rot:${[-1.5, 1, -1, 1.5, -1][i]}deg">
      <div class="flow-n">${String(i + 1).padStart(2, '0')}</div>
      <div><div class="flow-t">${esc(f.step)}</div><div class="flow-d">${esc(f.desc)}</div></div>
    </div>`).join('')}
  </div>
</section>
...
<section class="section">
  <div class="region-grid">
    ...
    ${L.regions.map(r => `<div class="region">
      <div class="region-top"><div class="region-name">${esc(r.name)}</div><div class="region-tz">${esc(r.tag)}</div></div>
